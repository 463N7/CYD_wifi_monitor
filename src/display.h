...
public:
  LGFX_CYD() 
  {
    ...
    { // --- PANEL config (ILI9341) ---
      ...
      cfg.memory_width   = 240; // swap height and width if screen is wrong (also adjust screen rotation under setup in main.cpp)
      cfg.memory_height  = 320; // swap height and width if screen is wrong (also adjust screen rotation under setup in main.cpp)
      cfg.panel_width    = 240; // swap height and width if screen is wrong (also adjust screen rotation under setup in main.cpp)
      cfg.panel_height   = 320; // swap height and width if screen is wrong (also adjust screen rotation under setup in main.cpp)
      cfg.offset_x       = 0;
      cfg.offset_y       = 0;
